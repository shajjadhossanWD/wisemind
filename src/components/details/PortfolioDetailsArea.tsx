            ...
            <div className="anim_div_ShowDowns">
              <div className="cs_img_show_text cs_text_style_1">
                ...
                <p className="cs_text_style_body">
                  ...
                  digital marketing and adver tising, we have the tools and
                  expertise to elevate your online presence. Welcome to our
                  Wisemind! We specialize in helping businesses like yours
                  online. From website design and development to digital
                  marketing and advertising, we have the tools and expertise to
                  elevate your online presence. Welcome to our Wisemind! We
                  specialize in helping businesses like yours succeed online.
                </p>
              </div>
              <div className="cs_ul_ml">
                <ul>
                  <li>Design Welcome to wisemind.!</li>
                  <li>
                    Dev online. From website design Implementation world of
                    digital.
                  </li>
                  <li>
                    Implementation evolving world of digital Design Welcome to
                    wisemind!
                  </li>
                  <li>
                    Launch growth and reach your goals. Implementation evolving
                    world of digital.
                  </li>
                </ul>
              </div>
            ...
            <div className="cs_portfolio_details">
              <div className="cs_solutions_section anim_div_ShowDowns">
                <div>
                  ...
                  <p className="cs_text_style_body">
                    Welcome to wisemind.! We specialize in helping businesses
                    like yours succeed online. From website design and
                    development to digital marketing and adver tising, we have
                    the tools and expertise to elevate your online presence.
                    Welcome to our Wisemind! We specialize in helping businesses
                    like yours online. From website design and development to
                    digital marketing and advertising, we have the tools and
