...
const innovative_data: DataType = {
  ...
  des_1: `Welcome to wisemind.! We specialize in helping businesses like yours succeed online. From website design and development to digital marketing and advertising,`,
  title_2: `Creating a Strong Brand Identity`,
  des_2: `Welcome to wisemind.! We spec ialize in helping businesses like yours succeed Well come to our Wisemind`,
  features: [
    {
      id: 1,
      title: `Ideation`,
