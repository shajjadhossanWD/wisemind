...
const hero_data = {
  subtitle: `Welcome to wisemind.!`,
  title_1: `Startup Sprint Accelerating`,
  title_2: `Digital Growth`,
  des: `Welcome to wisemind.! We specialize in helping businesses like yours succeed online. From website design and development to digital marketing and advertising, we have the tools.`,
};
