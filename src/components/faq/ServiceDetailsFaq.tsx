...
const service_faq_content: DataType = {
  ...
  description: `Welcome to wisemind.! We specialize in helping businesses like yours succeed online. From website design and development to digital marketing and advertising, we have the tools and expertise to elevate your online presence.`,
  features: [
